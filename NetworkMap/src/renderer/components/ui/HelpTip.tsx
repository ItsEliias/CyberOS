// NetworkMap — HelpTip.tsx — Small `?` icon button with hover/click popover
// Self-contained per app. Accent: amber #d29922.
...
export interface HelpTipProps {
  ...
  width?: number
  /** Accent color for the trigger / heading (defaults to NetworkMap amber) */
  accent?: string
