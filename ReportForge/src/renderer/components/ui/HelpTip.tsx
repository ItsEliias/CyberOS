    ...
    >
      <button
        ...
        style={{
          ...
          borderRadius: '50%',
          background: visible ? 'rgba(63,185,80,0.18)' : 'rgba(63,185,80,0.08)',
          color: visible ? ACCENT : 'var(--text-muted, #8b949e)',
          border: `1px solid ${visible ? 'rgba(63,185,80,0.45)' : 'rgba(63,185,80,0.22)'}`,
          fontSize: 10,
          fontWeight: 700,
          fontFamily: 'inherit',
          cursor: 'help',
      ...
      {visible && (
        <span
          ...
          style={{
            ...
            boxShadow: '0 10px 30px rgba(0,0,0,0.55), 0 0 0 1px rgba(63,185,80,0.08)',
