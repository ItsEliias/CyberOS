...
const THEMES: Record<TerminalThemeName, Partial<import('xterm').ITheme>> = {
  default: {
    background: '#0f1117', foreground: '#e6edf3', cursor: '#00ff41',
    cursorAccent: '#0f1117', selectionBackground: 'rgba(0,255,65,0.3)',
    black: '#0d1117', brightBlack: '#484f58', red: '#ff4444', brightRed: '#ff6e6e',
    green: '#00ff41', brightGreen: '#56d364', yellow: '#e3b341', brightYellow: '#f0c040',
    blue: '#4a9eff', brightBlue: '#79c0ff', magenta: '#b44fff', brightMagenta: '#d2a8ff',
    cyan: '#56d4dd', brightCyan: '#87deea', white: '#b1bac4', brightWhite: '#ffffff',
  },
  matrix: {
