// TerminalLink — Soft lock screen shown when "Require CredVault session" is
// enabled and the shared SSO state reports CredVault as locked or expired.
    ...
    <div style={{
      ...
      >
        <div style={{
          ...
          <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#38d39f" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round">
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 4 }}>
          <span style={{ fontSize: 16, fontWeight: 600, color: '#e6edf3' }}>
            TerminalLink is locked
          </span>
          <span style={{ fontSize: 12, color: '#8b949e', lineHeight: 1.5 }}>
            Unlock CredVault to use your terminal sessions, snippets, and SSH profiles. The lock is
            enforced because you turned on “Require CredVault session” in the command palette.
          </span>
        </div>
